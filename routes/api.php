...
Route::post('purchase-orders', function (Request $request) {
    ...
    return $purchaseOrders->map(function($purchaseOrder){
        return[
            ...
            'description' => optional($purchaseOrder->supplier)->name . '-' . optional($purchaseOrder->supplier)->document_number,
        ];
    });
...
Route::post('quotes', function (Request $request) {
    ...
    return $quotes->map(function($quote){
        return[
            ...
            'description' => optional($quote->customer)->name . '-' . optional($quote->customer)->document_number,
        ];
    });
