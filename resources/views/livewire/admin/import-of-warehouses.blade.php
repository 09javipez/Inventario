<div>
    <x-wire-card>
        ...
        <p class="text-sm text-gray-500 mt-1">
            Completa la platilla con los datos de tus almacenes y subela aqui.
        </p>
        <div class="mt-4">
                ...
                <div class="p-4 bg-yellow-100 border border-yellow-100 rounded-md text-black mb-3">
                    @if ($importedCount)
                        ...
                        <p class="mt-1 text-sm">
                            Algunos almacenes no se pudieron cargar debido a errores.
                        </p>
                    @else
                        <i class="fas fa-xmark mr-2"></i>
                        <strong>No se importo ningun almacen</strong>
                        <p class="mt-1 text-sm">
                            Todos los almacenes tienen errores o el archivo no es valido.
                        </p>
                    @endif
                </div>
                <ul class="space-y-2">
